-- ============================================================
-- ESHOP BDD DISTRIBUEE - PROCEDURES SITE2 SCENARIO 2
...
BEGIN
    ...
    log_sync('INSERT', 'LIGNECOMMANDES2_S2', v_id, 'OK');
EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN
        log_sync('INSERT', 'LIGNECOMMANDES2_S2', v_id, 'ERREUR', 'Doublon detecte');
        RAISE;
    WHEN OTHERS THEN
        log_sync('INSERT', 'LIGNECOMMANDES2_S2', v_id, 'ERREUR', SQLERRM);
        RAISE;
END;
/
...
BEGIN
    ...
    log_sync('DELETE', 'LIGNECOMMANDES2_S2', v_id, 'OK');
EXCEPTION
    WHEN OTHERS THEN
        log_sync('DELETE', 'LIGNECOMMANDES2_S2', v_id, 'ERREUR', SQLERRM);
        RAISE;
END;
/
...
BEGIN
    ...
    log_sync('UPDATE', 'LIGNECOMMANDES2_S2', v_id, 'OK');
EXCEPTION
    WHEN OTHERS THEN
        log_sync('UPDATE', 'LIGNECOMMANDES2_S2', v_id, 'ERREUR', SQLERRM);
        RAISE;
END;
/
